---
name: pr-description
description: Create, improve, and update GitHub Pull Request descriptions for the current branch or a specified PR number. Use when the user asks to write or improve a PR description.
---
